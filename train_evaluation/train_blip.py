...
def start_train(args):
    ...
    mode = Constants.mode_blip

    approach_name = mode
    output_feature_size = 256

    is_bidirectional = True
    model_desc = GRUNet(hidden_size=output_feature_size, num_features=768, is_bidirectional=is_bidirectional)
    model_video = VideoModel(in_channels=768, out_channels=512, kernel_size=3, feature_size=512)
